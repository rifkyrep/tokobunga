...
(function() {
                    ...
                    return function(d) {
                        ...
                        if (1 == a.length)
                            ...
                            if (document.documentElement.doScroll && d) {
                                var j = function() {
                                    try { document.documentElement.doScroll("left") } catch (d) { setTimeout(j, 1);
                                        return }
                                    b() };
                                j() }
                        }
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        var e = CKEDITOR.event.prototype,
            b;
        for (b in e) a[b] == void 0 && (a[b] = e[b]) }, CKEDITOR.event.prototype = function() {
        function a(a) {
            var d = e(this);
            return d[a] || (d[a] = new b(a)) }
        var e = function(b) { b = b.getPrivate && b.getPrivate() || b._ || (b._ = {});
                return b.events || (b.events = {}) },
            b = function(b) { this.name = b;
                this.listeners = [] };
        ...
        return {
            ...
            on: function(b, d, g, e, m) {
                function j(a, f, n, r) { a = { name: b, sender: this, editor: a, data: f, listenerData: e, stop: n, cancel: r, removeListener: i };
                    return d.call(g, a) === false ? false : a.data }

                function i() { r.removeListener(b, d) }
                var n = a.call(this, b);
                if (n.getListenerIndex(d) < 0) { n = n.listeners;
                    g || (g = this);
                    isNaN(m) && (m = 10);
                    var r = this;
                    j.fn = d;
                    ...
                    for (var o = n.length - 1; o >= 0; o--)
                        if (n[o].priority <= m) { n.splice(o + 1, 0, j);
                            return { removeListener: i } }
                    n.unshift(j) }
                return { removeListener: i } },
            once: function() {
                var b = arguments[1];
                arguments[1] = function(d) { d.removeListener();
            ...
            fireOnce: function(b, d, a) { d = this.fire(b, d, a);
                delete e(this)[b];
                return d },
    ...
    CKEDITOR.env || (CKEDITOR.env = function() {
        ...
        var c = 0;
        if (b.ie) { c = b.quirks || !document.documentMode ? parseFloat(a.match(/msie (\d+)/)[1]) : document.documentMode;
            b.ie9Compat = c == 9;
            b.ie8Compat = c == 8;
            b.ie7Compat = c == 7;
        ...
        if (b.ie) { b.cssClass = b.cssClass + (" cke_browser_ie" + (b.quirks || b.version < 7 ? "6" : b.version));
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            extend: function(b) {
                ...
                else if (typeof(d = arguments[a - 2]) == "boolean") { g = arguments[a - 1];
                    a = a - 2 }
                for (var e = 1; e < a; e++) {
                    var m = arguments[e],
                        j;
            ...
            createClass: function(b) {
                var a = b.$,
                    ...
                    e = b.proto,
                    b = b.statics;
                !a && (a = function() { d && this.base.apply(this, arguments) });
                if (g) var m = a,
                    a = function() {
                        var d = this._ || (this._ = {}),
                            a;
                ...
                if (d) {
                    ...
                    a.prototype.base = function() { this.base = d.prototype.base;
            ...
            addFunction: function(b, c) {
                return a.push(function() {
                    return b.apply(c || this, arguments) }) - 1 },
            ...
            defer: function(a) {
                return function() {
                    var c = arguments,
                        d = this;
                    window.setTimeout(function() { a.apply(d, c) }, 0) } },
            ...
            fixDomain: function() {
                for (var a;;) try {
                    ...
                    break
                } catch (c) { a = a ? a.replace(/.+?(?:\.|$)/, "") : document.domain;
                    if (!a) break;
                    document.domain = a }
                return !!a
            },
            eventsBuffer: function(a, c) {
                function d() { e = (new Date).getTime();
                    g = false;
                    c() }
                var g, e = 0;
                return { input: function() {
                        if (!g) {
                            ...
                            c < a ? g = setTimeout(d, a - c) : d() } }, reset: function() { g && clearTimeout(g);
                        g = e = 0 } } },
            enableHtml5Elements: function(a, c) {
                for (var d = ["abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "figcaption", "figure", "footer",
                    ...
                    ], g = d.length, e; g--;) { e = a.createElement(d[g]);
                    c && a.appendChild(e) }
            }
        }
    })();
    CKEDITOR.dtd = function() {
        ...
        a(e, {
            $block: a({ audio: 1, dd: 1, dt: 1, figcaption: 1, li: 1, video: 1 }, d, j),
            $blockLimit: {
                article: 1,
                aside: 1,
                audio: 1,
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        clone: function(a, e) {
            var b = this.$.cloneNode(a),
                c = function(d) { d["data-cke-expando"] && (d["data-cke-expando"] = false);
                    if (d.nodeType == CKEDITOR.NODE_ELEMENT) { e || d.removeAttribute("id", false);
                        if (a)
            ...
            for (var a; this.getLast && (a =
                ...
                if (a.type == CKEDITOR.NODE_TEXT) {
                    var e = CKEDITOR.tools.rtrim(a.getText()),
                        b = a.getLength();
                    if (e) {
                        if (e.length < b) { a.split(e.length);
            ...
            for (var b = this.$.documentElement, c =
                ...
                if (e)
                    for (var g = -1, h = 0; h < b.childNodes.length; h++) {
                        ...
                        if (!(e === true && m.nodeType == 3 && m.previousSibling && m.previousSibling.nodeType == 3)) { g++;
                            if (g == d) { b = m;
                                break } } } else b = b.childNodes[d] }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            appendBogus: function(a) {
                if (a || CKEDITOR.env.needsBrFiller || CKEDITOR.env.opera) {
                    ...
                    if (!a || !a.is ||
                        !a.is("br")) { a = CKEDITOR.env.opera ? this.getDocument().createText("") : this.getDocument().createElement("br");
            ...
            setText: function(a) { CKEDITOR.dom.element.prototype.setText = this.$.innerText != void 0 ? function(a) {
                    return this.$.innerText = a } : function(a) {
            ...
            getTabIndex: CKEDITOR.env.ie ? function() {
                ...
                var a = this.$.tabIndex;
                if (a == void 0) { a = parseInt(this.getAttribute("tabindex"), 10);
                    isNaN(a) && (a = -1) }
                return a } : function() {
            ...
            isVisible: function() {
                var a = (this.$.offsetHeight || this.$.offsetWidth) && this.getComputedStyle("visibility") != "hidden",
                    b, c;
                if (a && (CKEDITOR.env.webkit || CKEDITOR.env.opera)) { b = this.getWindow();
            ...
            hasAttribute: function() {
                function a(b) { b = this.$.attributes.getNamedItem(b);
            ...
            mergeSiblings: function() {
                function a(b, d, c) {
                    if (d && d.type == CKEDITOR.NODE_ELEMENT) {
                        for (var e = []; d.data("cke-bookmark") || d.isEmptyInlineRemoveable();) { e.push(d);
                ...
                return function(b) {
                    if (b === false || CKEDITOR.dtd.$removeEmpty[this.getName()] || this.is("a")) { a(this, this.getNext(), true);
            ...
            setAttribute: function() {
                ...
                return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ?
                    function(b, c) { b == "class" ? this.$.className = c : b == "style" ? this.$.style.cssText = c : b == "tabindex" ? this.$.tabIndex = c : b == "checked" ? this.$.checked = c : b == "contenteditable" ? a.call(this, "contentEditable", c) : a.apply(this, arguments);
                        return this } : CKEDITOR.env.ie8Compat && CKEDITOR.env.secure ? function(b, c) {
                        if (b == "src" && c.match(/^http:\/\//)) try { a.apply(this, arguments) } catch (e) {} else a.apply(this, arguments);
                        return this } : a
            }(),
            ...
            removeAttribute: function() {
                ...
                return CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function(a) { a == "class" ? a = "className" : a == "tabindex" ? a = "tabIndex" : a == "contenteditable" && (a = "contentEditable");
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (a = 0; a < b.length; a++) this.removeStyle(b[a]) } else { b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a));
                    this.$.style.cssText || this.removeAttribute("style") }
            },
            setStyle: function(a,
                b) { this.$.style[CKEDITOR.tools.cssStyleToDomStyle(a)] = b;
                return this },
            ...
            getDocumentPosition: function(a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var n = this.$.getBoundingClientRect(),
                        ...
                        f = true;
                    if (CKEDITOR.env.ie) { f = e.getDocumentElement().contains(this);
                        e = e.getBody().contains(this);
                        f = i && e || !i && f }
                    if (f) { b = n.left + (!i && r.scrollLeft || j.$.scrollLeft);
                        b = b - u;
                    ...
                    for (e = null; j && !(j.getName() == "body" || j.getName() == "html");) {
                        ...
                        if (!j.equals(this)) { b = b + (j.$.clientLeft || 0);
                            c = c + (j.$.clientTop || 0) }
                        for (; e && !e.equals(j);) {
                            b = b -
                                e.$.scrollLeft;
                ...
                if (a) { j = this.getWindow();
                    e = a.getWindow();
                    if (!j.equals(e) && j.$.frameElement) { a = (new CKEDITOR.dom.element(j.$.frameElement)).getDocumentPosition(a);
                        b = b + a.x;
                        c = c + a.y } }
                if (!document.documentElement.getBoundingClientRect && CKEDITOR.env.gecko && !i) { b = b + (this.$.clientLeft ? 1 : 0);
                    ...
                    do {
                        ...
                        if (b.is("html")) {
                            ...
                            try {
                                ...
                                e && (b = new CKEDITOR.dom.element(e)) } catch (j) {} }
                    } while (b = b.getParent())
                }
            },
            scrollIntoParent: function(a, b, c) {
                ...
                function o(a, b) {
                    ...
                    c = a.getWindow();
                    if (!c.equals(b)) { c = o(CKEDITOR.dom.element.get(c.$.frameElement), b);
                        d.x = d.x + c.x;
                        d.y = d.y + c.y }
                    return d
                }
            ...
            copyAttributes: function(a,
                ...
                for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                    ...
                    if (!(i in b))
                        ...
                        else if (j.specified || CKEDITOR.env.ie && j.nodeValue && i == "value") { n = this.getAttribute(i);
            ...
            forEach: function(a, b, c) {
                ...
                if (e !== false)
                    for (var c = this.getChildren(), j = 0; j < c.count(); j++) { e = c.getItem(j);
    ...
    (function() {
        function a(a, b) {
            ...
            g = k ? function(a, b) {
                return m(a, b) === false ? false : k(a, b) } : m;
            ...
            for (; f && !this._.end;) { this.current = f;
                if (!this.evaluator || this.evaluator(f) !== false) {
                    if (!b) return f } else if (b && this.evaluator) return false;
                f = f[j](false, q, g) }
            this.end();
        ...
        CKEDITOR.dom.walker.ignored = function(a) {
            return function(b) { b = h(b) || m(b) || j(b);
                return !!(a ^ b) } };
    ...
    (function() {
        ...
        var c = function(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset },
            d = function(a, b, c, d) {
                ...
                if (e.type == CKEDITOR.NODE_TEXT) e = e.split(l);
                    ...
                    if (l >= e.getChildCount()) { e = e.append(a.document.createText(""));
                        k = true } else e = e.getChild(l);
                if (f.type == CKEDITOR.NODE_TEXT) { f.split(g);
                    f.equals(e) && (e = f.getNext()) } else if (g)
                    if (g >= f.getChildCount()) { f = f.append(a.document.createText(""));
                        p = true } else f = f.getChild(g).getPrevious();
                else { f = f.append(a.document.createText(""), 1);
                    p = true }
                var g = f.getParents(),
                    l = e.getParents(),
                    q, j, t;
                for (q = 0; q < g.length; q++) { j = g[q];
                    t = l[q];
                    if (!j.equals(t)) break }
                ...
                if (b == 2) { j = a.startContainer;
                    if (j.type == CKEDITOR.NODE_TEXT) { j.$.data = j.$.data + j.$.nextSibling.data;
            ...
            g = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 },
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function() {
                ...
                return a },
            collapse: function(a) {
                if (a) { this.endContainer = this.startContainer;
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        } else { m && (q = i.getChild(m - 1) || i.getLast());
                            q || (k = i) }
                        for (k = c(k); k || q;) {
                            if (k && !q) {!j && k.equals(e) && (j = true);
                                if (f ? k.isBlockBoundary() : !g.contains(k)) break;
                                if (!t || k.getComputedStyle("display") != "inline") { t = false;
                            ...
                            for (; q;) {
                                ...
                                if (q.type == CKEDITOR.NODE_COMMENT) q = q.getPrevious();
                                    ...
                                    if (q.type == CKEDITOR.NODE_TEXT) { h = q.getText();
                                        d.test(h) && (q = null);
                                        i = /[\s\ufeff]$/.test(h) } else if ((q.$.offsetWidth >
                                            0 || b && q.is("br")) && !q.data("cke-bookmark"))
                                        if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) { h = q.getText();
                                            if (d.test(h)) q = null;
                                            else
                                                for (var m = q.$.getElementsByTagName("*"), K = 0, C; C = m[K++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) { q = null;
                                                        break }
                                            q && (i = !!h.length) } else q = null;
                                    i && (t ? j ? l = k : k && this.setStartBefore(k) : t = true);
                                    if (q) { i = q.getPrevious();
                                        if (!k && !i) { k = q;
                                            q = null;
                                            break }
                                        q = i } else k = null
                        ...
                        if (i.type == CKEDITOR.NODE_TEXT)
                            if (CKEDITOR.tools.trim(i.substring(m)).length) t = true;
                                ...
                                t = !i.getLength();
                                if (m == i.getLength()) {
                                    if (!(q = i.getNext())) k = i.getParent() } else O(i,
                                    m) && (k = i.getParent())
                            }
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var I, v, x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            G = null,
                            B = function(a) {
                                if (a.type == CKEDITOR.NODE_ELEMENT && a.getAttribute("contenteditable") == "false")
                                    if (G) {
                                        if (G.equals(a)) { G = null;
                                            return } } else G = a;
                                else if (G) return;
                                var b = x(a);
                                b || (I = a);
            ...
            removeEmptyBlocksAtEnd: function() {
                ...
                return function(b) {
                    for (var c = this.createBookmark(),
                            d = this[b ? "endPath" : "startPath"](), e = d.block || d.blockLimit, l; e && !e.equals(d.root) && !e.getFirst(a(e));) { l = e.getParent();
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                if (this._.nestedEditable) {
                    if (b = this._.nestedEditable.iterator.getNextParagraph(a)) { this.activeFilter = this._.nestedEditable.iterator.activeFilter;
                        return b }
                    this.activeFilter = this.filter;
                    if (c(this, a, this._.nestedEditable.container, this._.nestedEditable.remaining)) { this.activeFilter = this._.nestedEditable.iterator.activeFilter;
                ...
                if (!this._.started) {
                    ...
                    if (!f.collapsed) {
                        ...
                        if (this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary()) { s = this.range.clone();
                            s.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END);
                            if (s.checkEndOfBlock()) { s = new CKEDITOR.dom.elementPath(s.endContainer, s.root);
                ...
                for (this._.nextNode = null; s;) {
                    ...
                    if (p) s.type == CKEDITOR.NODE_TEXT && d.test(s.getText()) && (p = 0);
                        ...
                        var q = s.getName();
                        if (CKEDITOR.dtd.$block[q] && s.getAttribute("contenteditable") == "false") { b = s;
                            c(this, a, b);
                            break } else if (s.isBlockBoundary(this.forceBrBreak && !l && { br: 1 })) {
                            if (q == "br") p = 1;
                            else if (!h && !s.getChildCount() &&
                                q != "hr") { b = s;
                                r = s.equals(f);
                                break }
                            if (h) { h.setEndAt(s, CKEDITOR.POSITION_BEFORE_START);
                ...
                if (!b) {
                    ...
                    if (!b && s && !this.enforceRealBlocks && y[s.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !s.equals(h.root)) b = s;
                        ...
                        if (!h.checkStartOfBlock() || !h.checkEndOfBlock()) { b = b.clone(false);
                            h.extractContents().appendTo(b);
                            b.trim();
                            u = h.splitBlock();
                            o = !u.wasStartOfBlock;
                            u = !u.wasEndOfBlock;
                            h.insertNode(b) } } else if (!r) this._.nextNode = b.equals(f) ? null : e(h.getBoundaryNodes().endNode, 1, f)
                }
    ...
    (function() {
        function a(a, b, c, f, l) {
            ...
            if ((f || typeof a.elements != "function" || a.elements(k)) && (!a.match || a.match(b))) {
                if (f = !l) { a: if (a.nothingRequired) f = true;
                        else {
                            if (l = a.requiredClasses) { k = b.classes;
                                for (f = 0; f < l.length; ++f)
                                    if (CKEDITOR.tools.indexOf(k, l[f]) == -1) { f = false;
                                        break a } }
                ...
                if (!f) {
                    ...
                    if (!c.allClasses) { a = a.classes;
                        b = b.classes;
                        f = c.validClasses;
                        if (a)
                            if (a === true) b = true;
                            else {
                                for (var l = 0, k = b.length, g; l < k; ++l) { g = b[l];
                                    f[g] || (f[g] = a(g)) }
                                b = false }
                        else b = false;
                        c.allClasses = b }
                ...
                if (e) {
                    ...
                    if (!e.allAttributes)
                        for (w in t)
                            if (!q[w])
                                if (o.test(w)) {
                                    if (w != (C = w.replace(/^data-cke-saved-/, "")) &&
                                        !q[C]) { delete t[w];
                                        r = true }
                                } else { delete t[w];
                                    r = true }
        ...
        function h(a) {
            for (var b, c, d, f, e = {}, l = 1, a = t(a); b = a.match(C);) {
                if (c = b[2]) { d = m(c, "styles");
                    f = m(c, "attrs");
                    c = m(c, "classes") } else d = f = c = null;
        ...
        function f(a, b, c) {
            ...
            if (q.$empty[d] || !a.children.length)
                ...
                if (b == "br") {
                    if (a.previous && !u(a.previous)) { b = o();
                        b.insertBefore(a) }
                    if (a.next && !u(a.next)) { b = o();
                        b.insertAfter(a) }
                    ...
                    b: {
                        ...
                        for (var e = 0, l = d.length, k; e < l; ++e) {
                            k = d[e];
                            if (k.type ==
                                CKEDITOR.NODE_ELEMENT && !f[k.name]) { f = false;
                                break b }
                        }
                        f = true
                    }
                    if (f) { a.name = b;
                        ...
                        for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", g, l = d.length; l > 0;) {
                            ...
                            if (e && (k.type == CKEDITOR.NODE_TEXT || k.type == CKEDITOR.NODE_ELEMENT && q.$inline[k.name])) {
                                if (!g) { g = new CKEDITOR.htmlParser.element(b);
                                    g.insertAfter(a);
        ...
        function s(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d) { f = c[d];
                if ((!f.check || a.check(f.check, false)) && (!f.left || f.left(b))) { f.right(b, I);
                    break } } }
        ...
        CKEDITOR.filter.prototype = {
            allow: function(a, c, d) {
                ...
                for (k = d.length; e < k; ++e) {
                    ...
                    p.nothingRequired = t;
                    if (g.elements === true || g.elements === null) { g.elements = r(g.elements);
                        a[q ? "unshift" : "push"](g) } else { p = g.elements;
                        delete g.elements;
                        for (f in p)
                    ...
                    if (d.parent) switch (h.check) {
                        ...
                        case "parent-down":
                            d.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                                !q[d.parent.name][d.name] && f(d.parent, e, a)
                    }
                }
                return t
            },
            ...
            check: function(a, b, d) {
                ...
                if (typeof a == "string") {
                    ...
                    k = f.attributes || {};
                    if (e) { e = z(e);
                        k.style = CKEDITOR.tools.writeCssText(e, true) } else e = {};
                    e = {
                        name: f.element,
                        attributes: k,
            ...
            I = CKEDITOR.filter.transformationsTools = {
                ...
                transform: function(a, b) {
                    if (typeof b == "string") a.name = b;
                        ...
                        for (e in f)
                            if (e ==
                                "class") { c = a.classes.join("|");
                                for (k = f[e].split(/\s+/); g = k.pop();) c.indexOf(g) == -1 && a.classes.push(g) } else a.attributes[e] = f[e];
    ...
    (function() {
        var a, e = function(b) {
                ...
                if (!a) { e && (a = h.execCommand(e, { from: "keystrokeHandler" }) !== false);
        ...
        CKEDITOR.lang = {
            ...
            load: function(a, e, b) {
                if (!a || !CKEDITOR.lang.languages[a]) a = this.detect(e,
                    a);
                this[a] ? b(a, this[a]) : CKEDITOR.scriptLoader.load(CKEDITOR.getUrl("lang/" + a + ".js"), function() { this[a].dir = this.rtl[a] ? "rtl" : "ltr";
                    b(a, this[a]) }, this)
            },
            detect: function(a, e) {
        ...
        return {
            load: function(b, c, d, g) {
                ...
                var m = b.length,
                    j = [],
                    i = [],
                    n = function(a) { c && (h ? c.call(d, a) : c.call(d, j, i)) };
                if (m === 0) n(true);
                else {
                    var r = function(a, b) {
                            (b ? j : i).push(a);
                            if (--m <= 0) { g && CKEDITOR.document.getDocumentElement().removeStyle("cursor");
                                n(b) } },
                        o = function(b, c) { a[b] = 1;
                            var d = e[b];
                            delete e[b];
                                    ...
                                    if (c)
                                        if (CKEDITOR.env.ie && CKEDITOR.env.version < 11) f.$.onreadystatechange = function() {
                                            if (f.$.readyState == "loaded" || f.$.readyState == "complete") { f.$.onreadystatechange = null;
                                                o(b, true) } };
                                        else { f.$.onload = function() { setTimeout(function() { o(b, true) }, 0) };
                                            f.$.onerror = function() { o(b, false) } }
                    ...
                    a.call(this, b, function(a) {
                        ...
                        for (m in a) {
                            ...
                            if (!e[m]) {
                                ...
                                e[m] = 1 }
                            if (o) { o.split && (o = o.split(","));
                                for (r = 0; r < o.length; r++) g[o[r]] || b.push(o[r]) } }
                        if (b.length) h.call(this,
                            b);
                        else {
                            for (m in g) { r = g[m];
                                if (r.onLoad && !r.onLoad._called) { r.onLoad() === false && delete g[m];
                                    r.onLoad._called = 1 } }
                            c && c.call(d || window, g) }
                    }, this)
                };
    ...
    (function() {
        function a(a, c, g) {
            ...
            if (c !== void 0) {
                if (c instanceof CKEDITOR.dom.element) {
                    if (!g) throw Error("One of the element modes must be specified."); } else throw Error("Expect element of type CKEDITOR.dom.element.");
        ...
        function m(a) { CKEDITOR.skin.loadPart("editor", function() { j(a) }) }
        ...
        function i(a) { a.getStylesSet(function(b) { a.once("loaded", function() { a.fire("stylesSet", { styles: b }) }, null, null, 1);
                n(a) }) }
        ...
        function n(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var l in c) {
                    ...
                    if (h && !a.lang[l]) { h.split && (h = h.split(","));
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            execCommand: function(a, b) {
                ...
                if (c && c.state != CKEDITOR.TRISTATE_DISABLED && this.fire("beforeCommandExec", d) !== true) { d.returnValue = c.exec(d.commandData);
            ...
            setReadOnly: function(a) { a = a == void 0 || a;
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, d, g = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                    d = c.index;
                    if (d > g) { g = b.substring(g, d);
                        if (h) h.push(g);
                        else this.onText(g) }
                    g =
                        this._.htmlPartsRegex.lastIndex;
                    if (d = c[1]) { d = d.toLowerCase();
                        if (h && CKEDITOR.dtd.$cdata[d]) { this.onCDATA(h.join(""));
                            h = null }
                        if (!h) { this.onTagClose(d);
                            continue } }
                    if (h) h.push(c[0]);
                    else if (d = c[3]) { d = d.toLowerCase();
                        if (!/="/.test(d)) {
                            var m = {},
                                j;
                            c = c[4];
                            ...
                            this.onTagOpen(d, m, i);!h && CKEDITOR.dtd.$cdata[d] && (h = []) } } else if (d = c[2]) this.onComment(d)
                }
                if (b.length >
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(d, g, h) {
                ...
                if (s.length > 0)
                    for (var c = 0; c < s.length; c++) {
                        ...
                        if ((!k || k[e]) && (!a || !f || f[a] || !CKEDITOR.dtd[a])) {
                            ...
                            l = d;
                            s.splice(c, 1);
                            c-- } else if (e == l.name) { n(l, l.parent, 1);
                            c-- }
                    }
            }
            ...
            function n(b, c, d) {
                ...
                if (b.returnPoint) { l = b.returnPoint;
                    delete b.returnPoint } else l = d ? c : e
            }
            ...
            u.onTagOpen = function(d, f, g, h) {
                ...
                if (a(f)) s.push(f);
                    ...
                    if (d == "pre") k =
                        ...
                        if (d == "br" && k) { l.add(new CKEDITOR.htmlParser.text("\n"));
                            return }
                        d == "textarea" && (p = true) }
                    if (d == "br") y.push(f);
                    else {
                        for (;;) {
                            ...
                            if (!f.isUnknown && !l.isUnknown && !h[d])
                                ...
                                else if (d in b && g in b) { g = l.children;
                                (g = g[g.length - 1]) && g.name == "li" || n(g = new CKEDITOR.htmlParser.element("li"), l);!f.returnPoint && (f.returnPoint = l);
                                l = g } else if (d in CKEDITOR.dtd.$listItem && !o(d, g)) u.onTagOpen(d ==
                                "li" ? "ul" : "dl", {}, 0, 1);
                            else if (g in e && !o(d, g)) {!f.returnPoint && (f.returnPoint = l);
                                l = l.parent } else { g in CKEDITOR.dtd.$inline && s.unshift(l);
            ...
            u.onTagClose = function(a) {
                for (var b = s.length - 1; b >= 0; b--)
                    if (a == s[b].name) { s.splice(b, 1);
                        return }
                for (var c = [], d = [], e = l; e != f && e.name != a;) { e._.isBlockLike || d.unshift(e);
                    c.push(e);
            ...
            u.onText = function(a) {
                if ((!l._.hasInlineStarted || y.length) && !k && !p) { a = CKEDITOR.tools.ltrim(a);
                    if (a.length === 0) return }
                var d = l.name,
                    f = d ? CKEDITOR.dtd[d] || (l._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!p && !f["#"] && d in e) { u.onTagOpen(d in b ? "li" : d == "dl" ? "dd" : d == "table" ? "tr" : d == "tr" ? "td" : "");
                    u.onText(a) } else {
                    j();
                    m();
                    !k && !p && (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
            ...
            u.onCDATA = function(a) { l.add(new CKEDITOR.htmlParser.cdata(a)) };
            u.onComment = function(a) { j();
                m();
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            forEach: function(a, b, c) {
                if (!c && (!b || this.type == b)) var e = a(this);
                if (e !== false)
                    for (var c = this.children, j = 0; j < c.length; j++) { e = c[j];
                        e.type == CKEDITOR.NODE_ELEMENT ? e.forEach(a, b) : (!b || e.type == b) && a(e) } },
            getFilterContext: function(a) {
                return a || {}
            }
    ...
    (function() {
        ...
        a.prototype = {
            ...
            exec: function(a, c) {
                ...
                for (r = 0; r < m; r++) {
                    ...
                    if (!(a.nonEditable && !n.options.applyToAll ||
                            a.nestedEditable && n.options.excludeNestedEditable)) { n = n.value.apply(null, e);
            ...
            execOnName: function(a, c) {
                for (var d = 0, e = this.rules, h = e.length, m; c && d < h; d++) { m = e[d];!(a.nonEditable && !m.options.applyToAll || a.nestedEditable && m.options.excludeNestedEditable) && (c = c.replace(m.value[0], m.value[1])) }
                return c }
        }
    })();
    (function() {
                ...
                return function(b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in e || "data-cke-eol" in
                            ...
                            var k = c(b);!e && g(b.parent) ? h(b.parent, f(a)) : g(e) && (k && !g(k)) && f(a).insertBefore(e) }
                    }
                }
            }(v);
            return t
        ...
        function i(a) {
            return a.replace(w, function(a, b, c) {
                return "<" + b + c.replace(K, function(a, b) {
                    if (!/^on/.test(b) && c.indexOf("data-cke-saved-" + b) == -1) { a = a.slice(1);
                        return " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a }
                    return a }) + ">" }) }

        function n(a, b) {
            return a.replace(b, function(a, b, c) { a.indexOf("<textarea") === 0 && (a = b + u(c).replace(/</g, "&lt;").replace(/>/g, "&gt;") + "</textarea>");
        ...
        function s(a,
            ...
            for (var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = { id: 1 }), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g, function(a) {
                    return "<\!--{cke_tempcomment}" + (c.push(a) - 1) + "--\>" }), k = 0; k < d.length; k++) a = a.replace(d[k], function(a) { a = a.replace(f, function(a, b, d) {
                    return c[d] });
            ...
            return a.replace(/(['"]).*?\1/g, function(a) {
                return a.replace(/<\!--\{cke_protected\}([\s\S]+?)--\>/g, function(a, b) { e[e.id] = decodeURIComponent(b);
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, c, d) {
                var e = this.editor,
                    f, k, l;
                if (b && typeof b == "object") { f = b.context;
                    c = b.fixForBody;
                    d = b.dontFilter;
                    k = b.filter;
                    l = b.enterMode } else f = b;
            ...
            toDataFormat: function(a, b) {
                ...
                if (b) { c = b.context;
                    d = b.filter;
                    e = b.enterMode }!c && c !== null && (c = this.editor.editable().getName());
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (;;) { h = e.name;
                    if (!(m = a.onElementName(b, h))) { this.remove();
                        return false }
                    e.name = m;
                    if (!(e = a.onElement(b, e))) { this.remove();
                        return false }
                    if (e !== this) { this.replaceWith(e);
                        return false }
                    if (e.name == h) break;
                    if (e.type != CKEDITOR.NODE_ELEMENT) { this.replaceWith(e);
                        return false }
                    if (!e.name) { this.replaceWithChildren();
                        return false } }
                h = e.attributes;
                var j, i;
                for (j in h) {
    ...
    (function() {
        ...
        CKEDITOR.inlineAll = function() {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, g = c.count(); d < g; d++) { a = c.getItem(d);
    ...
    (function() {
        function a(a, c, h, m) {
            ...
            if (m == CKEDITOR.ELEMENT_MODE_REPLACE) { a.setStyle("visibility", "hidden");
            ...
            j.on("loaded", function() {
                ...
                j.setMode(j.config.startupMode, function() { j.resetDirty();
                    j.status = "ready";
            ...
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                ...
                if (e.name || e.id) {
                    if (typeof arguments[0] == "string") {
                        if (!RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)").test(e.className)) continue } else if (typeof arguments[0] == "function") { c = {};
        ...
        CKEDITOR.editor.prototype.setMode =
            function(a, b) {
                var c = this,
                    e = this._.modes;
                if (!(a == c.mode || !e || !e[a])) { c.fire("beforeSetMode", a);
                    if (c.mode) {
                        var j = c.checkDirty();
    ...
    (function() {
        function a(a) {
            ...
            if (b.config.autoParagraph !== false && b.activeEnterMode != CKEDITOR.ENTER_BR && b.editable().equals(l) && !d.block && k.collapsed && !k.getCommonAncestor().isReadOnly()) {
                ...
                if (!l.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) { b = k.fixBlock(true, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p");
        ...
        function g(a) {
            var b, e = a.getRanges()[0],
                d = a.root,
                p = { table: 1, ul: 1, ol: 1, dl: 1 };
            if (e.startPath().contains(p)) {
                var a =
                    function(a) {
                        return function(e, d) { d && (e.type == CKEDITOR.NODE_ELEMENT && e.is(p)) && (b = e);
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    if (k)
                        ...
                        b.collapse(true);
                        g.remove() } else b.splitBlock(e == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return true
                },
                    ...
                    if (this.insertElementIntoRange(a, d)) {
                        ...
                        if (g)
                            if ((g = a.getNext(function(a) {
                                    return c(a) && !j(a) })) && g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.$block)) g.getDtd()["#"] ? d.moveToElementEditStart(g) : d.moveToElementEditEnd(a);
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (l) {
                            d = e.getHead();
                            if (!d.getCustomData("stylesheet")) { l = e.appendStyleText(l);
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in p) {
                                var b = a.getSelection(),
                                    ...
                                    h = l.startPath(),
                                    i, j, m, c = c == 8;
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (d = b.getSelectedElement()) || (d = g(b))) { a.fire("saveSnapshot");
                                    l.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START);
                                    d.remove();
                                    l.select();
                                    a.fire("saveSnapshot");
                                    e = 1 } else if (l.collapsed)
                                    if ((i = h.block) && (m = i[c ? "getPrevious" : "getNext"](n)) && m.type == CKEDITOR.NODE_ELEMENT && m.is("table") &&
                                        l[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) { a.fire("saveSnapshot");
                                        l[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && i.remove();
                                        l["moveToElementEdit" + (c ? "End" : "Start")](m);
                                        l.select();
                                        a.fire("saveSnapshot");
                                        e = 1 } else if (h.blockLimit && h.blockLimit.is("td") && (j = h.blockLimit.getAscendant("table")) && l.checkBoundaryOfElement(j, c ? CKEDITOR.START : CKEDITOR.END) && (m = j[c ? "getPrevious" : "getNext"](n))) {
                                    a.fire("saveSnapshot");
                                    l["moveToElementEdit" + (c ? "End" : "Start")](m);
                        ...
                        a.blockless && (CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) && this.attachListener(this, "keyup", function(b) {
                            if (b.data.getKeystroke() in p && !this.getFirst(c)) { this.appendBogus();
                                b = a.createRange();
        ...
        CKEDITOR.on("instanceLoaded", function(b) {
            ...
            c.on("selectionChange", function(b) {
                if (!c.readOnly) {
                    ...
                    if (e && !e.isLocked) { e = c.checkDirty();
                        c.fire("lockSnapshot");
                        a(b);
        ...
        var o = function() {
                    ...
                    for (var t =
                        ...
                        if (a(d)) { l = d.getName();
                            if (o && l in CKEDITOR.dtd.$list) p = p.concat(b(d, e));
                                ...
                                if (l == "br" && d.data("cke-eol") && (!i || i == m - 1)) { r = (k = i ? p[i - 1].node : j.getItem(i + 1)) && (!a(k) || !k.is("br"));
                ...
                function e(b, c) {
                    ...
                    for (t && d.push(" "); p < l; p++) { g = k.getItem(p);
                ...
                function g(b, c, e, d) {
                    ...
                    if ((l = (new CKEDITOR.dom.walker(k)).next()) &&
                        a(l) && i[l.getName()] && (h = l.getPrevious()) && a(h) && !h.getParent().equals(b.startContainer) && e.contains(h) && d.contains(l) && l.isIdentical(h)) { l.moveChildren(h);
                        l.remove();
                        g(b, c, e, d) }
                }
                ...
                function k(b, c) {
                    function e(b, c) {
                        if (c.isBlock && c.isElement && !c.node.is("br") && a(b) && b.is("br")) { b.remove();
                            return 1 } }
                    var d = c.endContainer.getChild(c.endOffset),
                        k = c.endContainer.getChild(c.endOffset - 1);
                    d && e(d, b[b.length - 1]);
                    if (k && e(k, b[0])) { c.setEnd(c.endContainer, c.endOffset - 1);
                        c.collapse() } }
                var h = CKEDITOR.dtd,
                    i = {
                        p: 1,
                    ...
                    t = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 },
                ...
                return function(i, n, r) {
                    ...
                    if (!z.checkReadOnly()) {
                        var v = (new CKEDITOR.dom.elementPath(z.startContainer, z.root)).blockLimit || z.root,
                            n = { type: n, dontFilter: u, editable: i, editor: o, range: z, blockLimit: v, mergeCandidates: [], zombies: [] },
                            o = n.range,
                            u = n.mergeCandidates,
                            x, G, B, D;
                        if (n.type == "text" && o.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)) { x = CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>", o.document);
                            o.insertNode(x);
                            o.setStartAfter(x) }
                        ...
                        if (x) { o.setEndBefore(x);
                            o.collapse();
                            x.remove() }
                        x = o.startPath();
                        if (v = x.contains(d, false, 1)) { o.splitElement(v);
                        ...
                        if (x = r) {
                            x = n.range;
                            if (n.type == "text" && n.inlineStylesRoot) { D = n.inlineStylesPeak;
                                o = D.getDocument().createText("{cke-peak}");
                                for (u = n.inlineStylesRoot.getParent(); !D.equals(u);) { o = o.appendTo(D.clone());
                                    D = D.getParent() }
                            ...
                            D.setHtml(r);
                            if (P) { D.getFirst().remove();
                                D.getLast().remove() }
                            if ((P = x.startPath().block) && !(P.getChildCount() == 1 && P.getBogus())) a: {
                                var E;
                                if (D.getChildCount() == 1 && a(E = D.getFirst()) && E.is(t)) { P = E.getElementsByTag("*");
                                    x = 0;
                                    for (u = P.count(); x < u; x++) { o = P.getItem(x);
                                        if (!o.is(j)) break a }
                                ...
                                if (A) u = x > 0;
                                    ...
                                    if (o && B.isElement) {
                                        ...
                                        for (M = null; A && !h[A.getName()][B.name];) {
                                            if (A.equals(r)) { A = null;
                                                break }
                                            M = A;
                                            A = A.getParent() }
                                        if (A) {
                                            if (M) { S = E.splitElement(M);
                                                n.zombies.push(S);
                                                n.zombies.push(M) } } else {
                                            M = r.getName();
                                            T = !x;
                                            A = x == G.length - 1;
                                            M = e(B.node, M);
                        ...
                        if (!n.dontMoveCaret) {
                            for (F = a(L.startContainer) && L.startContainer.getChild(L.startOffset - 1); F && a(F) && !F.is(h.$empty);) {
                                if (F.isBlockBoundary()) L.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
                                    ...
                                    if (d(F) && F.getHtml().match(/(\s|&nbsp;)$/g)) { X = null;
                                        break }
                                    X = L.clone();
            ...
            u = function() {
                ...
                function b(a, c, e) { c = a.getDocument().createElement(c);
                    a.append(c, e);
                    return c }
                ...
                function c(a) {
                    var b = a.count(),
                        e;
                    for (b; b-- > 0;) { e = a.getItem(b);
                        if (!CKEDITOR.tools.trim(e.getHtml())) { e.appendBogus();
                ...
                return function(e) {
                    ...
                    if (!k) { k = e.clone();
                        ...
                        g = true }
                    k || (k = d);
                    if (k.is("table")) { e.setStartAt(k, CKEDITOR.POSITION_BEFORE_START);
                        e.collapse(true);
                        k.remove() } else {
    ...
    (function() {
        ...
        function b() { n = null;
            if (r) { CKEDITOR.tools.setTimeout(a, 0, this);
                r = false } }
        ...
        function m(a, b, c) {
            var e = a.on("focus", function(a) { a.cancel() }, null, null, -100);
            if (CKEDITOR.env.ie) var d = a.getDocument().on("selectionchange", function(a) { a.cancel() }, null, null, -100);
            else {
        ...
        function j(a) {
            ...
            var c = a.getSelection(),
                e = a.createRange(),
                d = c.root.on("selectionchange", function(a) { a.cancel() }, null, null, 0);
            ...
            return function(c) {
                ...
                if (b[e]) {
                    ...
                    if (d.length == 1 && f.collapsed)
                        if ((e = f[e < 38 ? "getPreviousEditableNode" : "getNextEditableNode"]()) && e.type == CKEDITOR.NODE_ELEMENT && e.getAttribute("contenteditable") == "false") { a.getSelection().fake(e);
        ...
        CKEDITOR.on("instanceCreated", function(b) {
            ...
            d.on("contentDom", function() {
                ...
                CKEDITOR.env.gecko && l.attachListener(l, "focus", function(a) {
                    ...
                    if (n !== 0)
                        if ((a = d.getSelection().getNative()) &&
                            a.isCollapsed && a.anchorNode == l.$) { a = d.createRange();
                            a.moveToElementEditStart(l);
                            a.select() }
                }, null, null, -2);
                l.attachListener(l, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() { n && CKEDITOR.env.webkit && (n = d._.previousActive && d._.previousActive.equals(b.getActive()));
                    d.unlockSelection(n);
                    n = 0 }, null, null, -1);
                l.attachListener(l, "mousedown", function() { n = 0 });
                if (CKEDITOR.env.ie || CKEDITOR.env.opera || j) {
                    var o = function() { m = new CKEDITOR.dom.selection(d.getSelection());
                        m.lock() };
                    f ? l.attachListener(l, "beforedeactivate",
                        o, null, null, -1) : l.attachListener(d, "selectionCheck", o, null, null, -1);
                    l.attachListener(l, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { d.lockSelection(m);
                        n = 1 }, null, null, -1);
                    l.attachListener(l, "mousedown", function() { n = 0 })
                }
                if (CKEDITOR.env.ie && !j) {
                    ...
                    if (b.$.compatMode != "BackCompat") {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) p.on("mousedown", function(a) {
                            ...
                            function d() { p.removeListener("mousemove", b);
                        ...
                        if (CKEDITOR.env.version > 7 && CKEDITOR.env.version < 11) {
                            p.on("mousedown", function(a) {
                                if (a.data.getTarget().is("html")) { c.on("mouseup", v);
                                    p.on("mouseup", v) } });
                            var v = function() {
                ...
                l.attachListener(l, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() { d.forceNextSelectionCheck();
                    d.selectionChange(1) });
                if (j ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                    var x;
                    l.attachListener(l, "mousedown", function() { x = 1 });
                    l.attachListener(b.getDocumentElement(), "mouseup", function() { x && e.call(d);
                        x = 0 }) } else l.attachListener(CKEDITOR.env.ie ? l : b.getDocumentElement(), "mouseup", e, d);
                CKEDITOR.env.webkit &&
        ...
        CKEDITOR.on("instanceReady", function(a) {
            ...
            if (CKEDITOR.env.webkit) {
                ...
                b.on("beforeSetMode", function() { g(b.editable()) }, null, null, -1);
                var c, e, a = function() {
                        var a = b.editable();
                        if (a)
                            if (a = d(a)) {
                    ...
                    f = function() {
                        var a = b.editable();
                        if (a)
                            if (a = d(a)) { a.setText(c);
                                if (e) { b.document.$.defaultView.getSelection().setPosition(a.$, a.getLength());
                                    e = 0 } } };
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (d)
                if (d.getRangeAt) g = (h = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(h.commonAncestorContainer);
                    ...
                    try { h = d.createRange() } catch (i) {}
                    g = h && CKEDITOR.dom.element.get(h.item && h.item(0) ||
                        h.parentElement())
                }
            if (!g || !(g.type == CKEDITOR.NODE_ELEMENT || g.type == CKEDITOR.NODE_TEXT) || !this.root.equals(g) && !this.root.contains(g)) { this._.cache.type = CKEDITOR.SELECTION_NONE;
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = f ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (var e = d.children, f, g, k = b.duplicate(), l = 0, h = e.length - 1, i = -1, j, n; l <= h;) { i = Math.floor((l + h) / 2);
                            f = e[i];
                        ...
                        if (i == -1 || i == e.length - 1 && j < 0) {
                            ...
                            for (d = e.length; k > 0 && d > 0;) { g = e[--d];
                                if (g.nodeType == CKEDITOR.NODE_TEXT) { n = g;
                        ...
                        for (; k > 0;) try { g = f[j > 0 ? "previousSibling" : "nextSibling"];
                            if (g.nodeType == CKEDITOR.NODE_TEXT) { k = k - g.nodeValue.length;
                                n = g }
                            f = g } catch (m) {
                            return {
                                container: d,
            ...
            selectRanges: function(a) {
                ...
                this.reset();
                if (b)
                    for (var b = this.root, d, e = 0; e < a.length; ++e) { d = a[e];
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        a: {
                            var j, n;
                            if (a.length == 1 && !(n = a[0]).collapsed && (i = n.getEnclosedNode()) && i.type == CKEDITOR.NODE_ELEMENT) { n = n.clone();
                        ...
                        if (i) this.fake(i);
                            ...
                            if (f) {
                                ...
                                if (a.length > 1) { i = a[a.length - 1];
                                    a[0].setEnd(i.endContainer, i.endOffset) }
                                i = a[0];
                                var a = i.collapsed,
                                    m, o, r;
                                if ((d = i.getEnclosedNode()) && d.type == CKEDITOR.NODE_ELEMENT && d.getName() in y && (!d.is("a") || !d.getText())) try { r = d.$.createControlRange();
                                    r.addElement(d.$);
                                    r.select();
                                    return } catch (s) {}(i.startContainer.type == CKEDITOR.NODE_ELEMENT && i.startContainer.getName() in b || i.endContainer.type == CKEDITOR.NODE_ELEMENT && i.endContainer.getName() in b) && i.shrink(CKEDITOR.NODE_ELEMENT, true);
                                r = i.createBookmark();
                                b =
                                    r.startNode;
                                if (!a) h = r.endNode;
                                ...
                                if (h) { j = i.document.$.body.createTextRange();
                                    j.moveToElementText(h.$);
                                    r.setEndPoint("EndToEnd", j);
                                    r.moveEnd("character", -1) } else { m = b.getNext(n);
                                ...
                                b.remove();
                                if (a) {
                                    if (m) { r.moveStart("character", -1);
                                        r.select();
                                        i.document.$.selection.clear() } else r.select();
                                    i.moveToPosition(o, CKEDITOR.POSITION_BEFORE_START);
                                    o.remove() } else { i.setEndBefore(h);
                                    h.remove();
                                    r.select() }
                            } else {
                                h = this.getNative();
                                if (!h) return;
                                if (CKEDITOR.env.opera) { r = this.document.$.createRange();
                                ...
                                for (r = 0; r < a.length; r++) {
                                    if (r < a.length - 1) {
                                        ...
                                        if (!j.collapsed) { j.shrink(CKEDITOR.NODE_ELEMENT, true);
                                            ...
                                            j = j.getEnclosedNode();
                                            if (o.isReadOnly() || j && j.isReadOnly()) { m.setStart(i.startContainer, i.startOffset);
                                                a.splice(r--, 1);
                                                continue } }
                                    }
                                    i = a[r];
                                    ...
                                    if (i.collapsed && CKEDITOR.env.webkit && c(i)) { m = this.root;
                                        g(m, false);
                                        j = m.getDocument().createText("​");
                                        m.setCustomData("cke-fillingChar", j);
                                        i.insertNode(j);
                                        if ((m = j.getNext()) && !j.getPrevious() && m.type == CKEDITOR.NODE_ELEMENT && m.getName() == "br") { g(this.root);
                                            i.moveToPosition(m, CKEDITOR.POSITION_BEFORE_START) } else i.moveToPosition(j, CKEDITOR.POSITION_AFTER_END) }
                                    o.setStart(i.startContainer.$, i.startOffset);
                                    try { o.setEnd(i.endContainer.$, i.endOffset) } catch (u) {
                                        if (u.toString().indexOf("NS_ERROR_ILLEGAL_VALUE") >=
                                            0) { i.collapse(1);
                                            o.setEnd(i.endContainer.$, i.endOffset) } else throw u;
                                    }
                                    h.addRange(o)
                                }
                            }
            ...
            removeAllRanges: function() {
                var a = this.getNative();
                try { a && a[f ? "empty" : "removeAllRanges"]() } catch (b) {}
                this.reset() }
        }
    })();
    "use strict";
    ...
    (function() {
            ...
            if (b.collapsed) { d = y(this, d);
                ...
                for (o.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(m)) { o = null;
                        ...
                        if (p && j && CKEDITOR.dtd.$block[q])
                            for (var t = o, w = c(t), z = void 0, C = w.length, H = 0, t = C && new CKEDITOR.dom.range(t.getDocument()); H < C; ++H) {
                                ...
                                if (J ? J.check(this) : 1) { t.selectNodeContents(z);
                                    e.call(this, t) } }
                    ...
                    if (h && r && !r.collapsed) {
                        ...
                        if (h) { r.extractContents().appendTo(h);
                            r.insertNode(h);
                            u.call(this, h);
                            h.mergeSiblings();
                            CKEDITOR.env.ie || h.$.normalize() } else { h = new CKEDITOR.dom.element("span");
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, i; h < e.elements.length && (i = e.elements[h]); h++) {
                    ...
                    if (this.checkElementRemovable(i)) {
                        var j;
                        if (a.collapsed && (a.checkBoundaryOfElement(i, CKEDITOR.END) || (j = a.checkBoundaryOfElement(i, CKEDITOR.START)))) { g = i;
                            g.match = j ? "start" : "end" } else { i.mergeSiblings();
                ...
                for (e = d; !e.equals(l);) { g = e.getNextSourceNode();
                    if (e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e)) { e.getName() == this.element ? o.call(this, e) : f(e, k(this)[e.getName()]);
                        if (g.type == CKEDITOR.NODE_ELEMENT && g.contains(d)) { b();
                            g = d.getNext() } }
                    e = g } }
            a.moveToBookmark(c);
        ...
        function h(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph();)
                if (!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1)) { f = y(this, e, d);
                    j(d, f) }
            a.moveToBookmark(b) }
        ...
        function o(a, b) {
            var c = this._.definition,
                ...
                h;
            for (h in d)
                if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != q(h, d[h])) && !(b && h.slice(0, 5) == "data-")) { g = a.hasAttribute(h);
                    a.removeAttribute(h) }
            for (var i in c)
                if (!(this._.definition.fullMatch && a.getStyle(i) != q(i, c[i], true))) { g = g || !!a.getStyle(i);
                    a.removeStyle(i) }
            f(a, e, t[a.getName()]);
        ...
        function u(a) {
            for (var b = k(this), c = a.getElementsByTag(this.element), d, e = c.count(); --e >= 0;) { d = c.getItem(e);
                d.isReadOnly() || o.call(this, d, true) }
            for (var g in b)
                if (g != this.element) { c = a.getElementsByTag(g);
        ...
        var t = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            J = {
                a: 1,
                embed: 1,
                hr: 1,
        ...
        CKEDITOR.editor.prototype.applyStyle = function(a) { a.checkApplicable(this.elementPath()) && z.call(a, this.getSelection()) };
        CKEDITOR.editor.prototype.removeStyle = function(a) { a.checkApplicable(this.elementPath()) && z.call(a, this.getSelection(), 1) };
        CKEDITOR.style.prototype = {
            ...
            applyToObject: function(a) { l(a, this) },
            checkActive: function(a) {
                switch (this.type) {
                    ...
                    case CKEDITOR.STYLE_INLINE:
                        for (var b = a.elements, c = 0, d; c < b.length; c++) { d = b[c];
            ...
            checkElementMatch: function(a, b) {
                ...
                if (typeof this.element == "string" ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c)
                            if (h !=
                                "_length") { e = a.getAttribute(h) || "";
                                if (h == "style") a: { d = c[h];typeof d == "string" && (d = CKEDITOR.tools.parseCssText(d));typeof e == "string" && (e = CKEDITOR.tools.parseCssText(e, true));g = void 0;
                                    for (g in d)
        ...
        CKEDITOR.dom.elementPath = function(b, d) {
            ...
            do
                if (j.type == CKEDITOR.NODE_ELEMENT) {
                    m.push(j);
                    if (!this.lastElement) { this.lastElement = j;
                    ...
                    if (!h) {
                        ...
                        if (a[i]) {
                            var n;
                            if (n = !g) {
                                if (i = i == "div") { a: { i = j.getChildren();n = 0;
                                        for (var r = i.count(); n < r; n++) {
                                            var o = i.getItem(n);
                                            if (o.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[o.getName()]) { i = true;
                                                break a } }
                                        i = false }
                                    i = !i }
                                n = i }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        split: function(a) {
            ...
            if (e.childNodes.length == b)
                if (a >= c) { g = d.createText("");
                    g.insertAfter(this) } else { a = d.createText("");
                    a.insertAfter(g);
                    a.remove() }
            return g },
    ...
    (function() {
        function a(a, c, d) {
            ...
            if (h.equals(j.getPrevious())) { c.startOffset = c.startOffset - h.getLength() - a.getPrevious().getLength();
        ...
        var e = {
                ...
                return {
                    getNextRange: function(h) {
                        ...
                        if (m && a.length > 1) {
                            ...
                            if (h)
                                for (var i = 0; a[e + i + 1];) {
                                    for (var n = m.document, h = 0, j = n.getById(d[i].endNode), n = n.getById(d[i +
                                            1].startNode);;) { j = j.getNextSourceNode(false);
                                        if (n.equals(j)) h = 1;
                            ...
                            for (m.moveToBookmark(d.shift()); i--;) { j = a[++e];
            ...
            createBookmarks: function(b) {
                for (var c = [], d, e = 0; e < this.length; e++) { c.push(d = this[e].createBookmark(b, true));
                    for (var h = e + 1; h < this.length; h++) { this[h] = a(d, this[h]);
    ...
    (function() {
        ...
        function e(b) {
            ...
            if (c)
                for (var c = c.split(",").sort(function(a, b) {
                        return a > b ? -1 : 1 }), e = 0, g; e < c.length; e++) { g = c[e];
        ...
        function b(a, b) {
            if (!g[a]) { CKEDITOR.document.appendStyleSheet(e(a));
                g[a] = 1 }
            b && b() }
            ...
            for (var g = 0; g < a.length; g++)
                if (CKEDITOR.env.webkit)
                    for (e = 0; e < b.length; e++) { f = b[e][1];
                        ...
                        a[g].$.sheet.addRule(b[e][0], f) } else {
                        f = b;
                        for (d = 0; d < c.length; d++) f = f.replace(c[d][0], c[d][1]);
                        CKEDITOR.env.ie &&
    ...
    */
        ...
        onLoad: function() {
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        b.on("load", function() { f.getInputElement().on("keydown", function(a) { a.data.getKeystroke() == 13 && (h = true) });
                            f.getInputElement().on("keyup", function(a) {
                                if (a.data.getKeystroke() == 13 && h) { b.getButton("ok") && setTimeout(function() { b.getButton("ok").click() }, 0);
            ...
            CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
                setValue: function(b, a) {
                    for (var d = this._.children, e, c = 0; c < d.length && (e = d[c]); c++) e.getElement().$.checked = e.getValue() == b;!a && this.fire("change", { value: b }) },
                getValue: function() {
    ...
    (function() {
        ...
        function J(a) {
            ...
            if (CKEDITOR.env.ie6Compat) {
                ...
                b.$.setTimeout(function() { l.prevScrollHandler = window.onscroll || function() {};
                    window.onscroll = l }, 0);
                i() }
        }
                    ...
                    if (b.contents[e]) {
                        ...
                        if (d) {
                            for (var i in this._.contents[a.id]) {
                                var l = this._.contents[a.id][i]; "hbox" == l.type || ("vbox" == l.type || !l.getInputElement()) || (l.requiredContent && !this._.editor.activeFilter.check(l.requiredContent) ? l.disable() : (l.enable(), f++)) }!f || g && !this._.editor.activeFilter.check(g) ?
        ...
        L.prototype = {
            ...
            removeContents: function(a) { B(this.contents, a) },
        ...
        CKEDITOR.ui.dialog.hbox.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, { getChild: function(a) {
                ...
                a.splice || (a = [a]);
                return 2 > a.length ? this._.children[a[0]] : this._.children[a[0]] && this._.children[a[0]].getChild ? this._.children[a[0]].getChild(a.slice(1, a.length)) : null } }, !0);
    ...
    (function() {
        function w(b) {
            ...
            function c(e) {
                return { type: e, canUndo: "cut" == e, startDisabled: !0, exec: function() { "cut" == this.type && i();
                        var e;
                        var a = this.type;
            ...
            function d() {
                return {
                    ...
                    async: !0,
                    exec: function(b, a) {
                        var d = function(a, d) { a && g(a.type, a.dataValue, !!d);
            ...
            function o() {
                if (CKEDITOR.env.ie) { b.focus();
                    ...
                    a.unlock() } else try {
                    if (b.editable().fire(q) && !b.document.$.execCommand("Paste", !1, null)) throw 0; } catch (d) {
                    return !1 }
                return !0 }
            ...
            function u(a) {
                ...
                k(a, function(b) { b = b.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/ig, "");
                    c && g(d.type, b, 0, 1) }) }
            ...
            (function() {
                b.on("key", p);
                b.on("contentDom", a);
                b.on("selectionChange", function(a) { t = a.data.selection.getRanges()[0].checkReadOnly();
                    s() });
                b.contextMenu &&
                    b.contextMenu.addListener(function(a, b) { t = b.getRanges()[0].checkReadOnly();
        ...
        function x(b) {
            if (CKEDITOR.env.webkit) {
                ...
                if (!b.match(/^([^<]|<br( ?\/)?>)*$/gi) && !b.match(/^(<p>([^<]|<br( ?\/)?>)*<\/p>|(\r\n))*$/gi)) return "html" } else if (CKEDITOR.env.gecko || CKEDITOR.env.opera) {
            ...
            b.addRules({
                elements: {
                    ...
                    $: function(b) {
                        ...
                        else if (f[k]) { g = new CKEDITOR.htmlParser.element("cke:br");
                            g.isEmpty = !0;
        ...
        function A(b, a, c) {
            ...
            var a = d.getHtml(),
                ...
                a = a.replace(/<\/?p>/g, function(a) {
                    if ("<p>" == a) {
                        if (1 < ++f) return "</p><p>" } else if (0 < --f) return "</p><p>";
            ...
            init: function(b) {
                ...
                b.on("paste", function(a) {
                        var b = a.data.dataValue,
                            ...
                            return b.replace(/\t/g, "&nbsp;&nbsp; &nbsp;") })), -1 < b.indexOf('<br class="Apple-interchange-newline">') && (a.data.startsWithEOL = 1, a.data.preSniffing = "html", b = b.replace(/<br class="Apple-interchange-newline">/, "")), b = b.replace(/(<[^>]+) class="Apple-[^"]*"/gi, "$1"));
                        ...
                        CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function(b, d) {
                            if (d.toLowerCase() in f) { a.data.preSniffing = "html";
                                return "<" + d }
                            return b }) : CKEDITOR.env.webkit ? b = b.replace(/<\/(\w+)><div><br><\/div>$/, function(b, d) {
                            if (d in f) { a.data.endsWithEOL = 1;
                                return "</" + d + ">" }
                ...
                b.on("paste", function(c) {
                    ...
                    h = "html" == d || "html" == c.preSniffing ? "html" : x(f); "htmlifiedtext" == h ? f = y(b.config, f) : "text" == d && "html" == h && (f = A(b.config, f, a || (a = z(b))));
                    c.startsWithEOL && (f = '<br data-cke-eol="1">' + f);
                    c.endsWithEOL && (f += '<br data-cke-eol="1">'); "auto" == d && (d = "html" == h || "html" == l ? "html" : "text");
                    c.type = d;
                    c.dataValue = f;
    ...
    (function() {
        ...
        CKEDITOR.ui.panel.prototype = {
            render: function(a, b) {
                ...
                var d = { editorId: a.id, id: this.id, langCode: a.langCode, dir: a.lang.dir, cls: this.className, frame: "", env: CKEDITOR.env.cssClass, "z-index": a.config.baseFloatZIndex + 1 };
                if (this.isFramed) {
            ...
            proto: {
                ...
                showBlock: function(a, b, c, i, f, h) {
                    ...
                    j.onEscape = CKEDITOR.tools.bind(function(a) {
                        if (this.onEscape && this.onEscape(a) === false) return false }, this);
                ...
                focus: function() {
                    if (CKEDITOR.env.webkit) {
                        var a = CKEDITOR.document.getActive();!a.equals(this._.iframe) && a.$.blur() }(this._.lastFocused || this._.iframe.getFrameDocument().getWindow()).focus() },
                blur: function() {
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function(e, c, b, i) {
                if (b = b || q(e)) {
                    ...
                    } else if (a && a.is("pre") && !h) { o(e, c, b, i);
                        return }
                    if (h = b.splitBlock(k)) {
                        c = h.previousBlock;
                        a = h.nextBlock;
                        ...
                        if (!e && !j) a.is("li") && (d = b.clone(), d.selectNodeContents(a), d = new CKEDITOR.dom.walker(d), d.evaluator = function(a) {
                            ...
                            if (c) {
                                if (c.is("li") || !r.test(c.getName()) && !c.is("pre")) d = c.clone() } else a && (d = a.clone());
                            d ? i && !d.is("li") && d.renameNode(k) : g && g.is("li") ? d = g : (d = f.createElement(k), c && (m = c.getDirection()) && d.setAttribute("dir",
                                m));
                            if (f = h.elementPath) { i = 0;
                                for (k = f.elements.length; i < k; i++) { g = f.elements[i];
    ...
    (function() {
        ...
        var i = CKEDITOR.htmlParser.cssStyle,
            ...
            k = CKEDITOR.plugins.add("fakeobjects", { init: function(a) { a.filter.allow("img[!data-cke-realelement,src,alt,title](*){*}", "fakeobjects") }, afterInit: function(a) {
        ...
        function g(a, b, g, h, j, n, l, o) {
            ...
            a.ui.addRichCombo(b, {
                ...
                onClick: function(b) { a.focus();
                    ...
                    a.fire("saveSnapshot") },
                onRender: function() { a.on("selectionChange", function(a) {
                        for (var b = this.getValue(), a = a.data.path.elements, c = 0, d; c < a.length; c++) { d = a[c];
                            for (var e in f)
                                if (f[e].checkElementMatch(d, !0)) { e != b && this.setValue(e);
                                    return } }
    ...
    CKEDITOR.plugins.add("forms", {
        ...
        init: function(b) {
            ...
            b.contextMenu && (!b.blockless && b.contextMenu.addListener(function(g, c, b) {
                if ((g = b.contains("form", 1)) && !g.isReadOnly()) return { form: CKEDITOR.TRISTATE_OFF } }), b.contextMenu.addListener(function(b) {
                if (b && !b.isReadOnly()) {
                    var c = b.getName();
        ...
        afterInit: function(b) {
            ...
            a && a.addRules({ elements: { input: function(a) {
                        if ("hidden" == a.attributes.type) return b.createFakeParserElement(a, "cke_hidden", "hiddenfield") } } }, { applyToAll: !0 })
        }
    });
    CKEDITOR.env.ie && (CKEDITOR.dom.element.prototype.hasAttribute = CKEDITOR.tools.override(CKEDITOR.dom.element.prototype.hasAttribute, function(b) {
        return function(a) { this.$.attributes.getNamedItem(a);
    ...
    (function() {
        ...
        function l() {
            ...
            if (8 <= CKEDITOR.document.$.documentMode) { a.push("html.CSS1Compat [contenteditable=false]{min-height:0 !important}");
                ...
                a.push(d.join(",") + "{display:inline-block}") } else CKEDITOR.env.gecko && (a.push("html{height:100% !important}"), a.push("img:-moz-broken{-moz-force-broken-image-icon:1;min-width:24px;min-height:24px}"));
            ...
            init: function(a) {
                ...
                a.addMode("wysiwyg", function(d) {
                    ...
                    CKEDITOR.env.webkit && (c = function() { g.setStyle("width", "100%");
                        ...
                        g.removeStyle("width");
                        e.show() }, e.setCustomData("onResize", c), CKEDITOR.document.getWindow().on("resize",
                        c));
                    a.fire("ariaWidget", e)
                })
            }
        ...
        var j = CKEDITOR.tools.createClass({
            $: function(a) { this.base.apply(this, arguments);
    ...
    (function() {
        function s(e) {
            function g(b) {
                ...
                for (a = 0; a < h.length; a++)
                    if (h[a].getName && k[h[a].getName()]) { b = h[a];
                        break }
        ...
        function p(e, g) { g || (g = e.contains(this.context));
                    ...
                    this.jobs[this.isIndent ? 10 : 30] = {
                        refresh: this.isIndent ? function(e, d) {
                            var b = this.getContext(d),
                                c = p.call(this, d, b);
                            return !b || !this.isIndent || c ? q : r } : function(e, d) {
    ...
    CKEDITOR.plugins.add("link", {
        ...
        init: function(b) {
            ...
            b.ui.addButton && (b.ui.addButton("Link", {
                ...
                command: "link",
                toolbar: "links,10"
            }), b.ui.addButton("Unlink", { label: b.lang.link.unlink, command: "unlink", toolbar: "links,20" }), b.ui.addButton("Anchor", { label: b.lang.link.anchor.toolbar, command: "anchor", toolbar: "links,30" }));
        ...
        afterInit: function(b) {
            ...
            d && d.addRules({ elements: { a: function(a) {
                        ...
                        if (CKEDITOR.plugins.link.synAnchorSelector) {
                            ...
                            d && CKEDITOR.plugins.link.emptyAnchorFix && (c.contenteditable = "false", c["data-cke-editable"] = 1) } else if (CKEDITOR.plugins.link.fakeAnchor && d) return b.createFakeParserElement(a, "cke_anchor", "anchor");
                        return null } } });
            CKEDITOR.plugins.link.emptyAnchorFix &&
                a && a.addRules({ elements: { a: function(a) { delete a.attributes.contenteditable } } });
    ...
    CKEDITOR.unlinkCommand.prototype = { exec: function(b) {
            ...
            b.removeStyle(a) }, refresh: function(b, a) {
    ...
    (function() {
        function E(c, k, e) {
            ...
            for (h = f + 1; h < j.length; h++)
                if (j[h].indent > j[h - 1].indent + 1) { g = j[h - 1].indent + 1 - j[h].indent;
                ...
                c.blockless || (c.addCommand("numberedlist", new x("numberedlist", "ol")), c.addCommand("bulletedlist",
                    ...
                    if (c.mode == "wysiwyg" && e in { 8: 1, 46: 1 }) {
                        ...
                        if (b && b.collapsed) {
                            ...
                            if (g) {
                                var a, d;
                                if ((a = j.contains(r)) && b.checkBoundaryOfElement(a, CKEDITOR.START) && (a = a.getParent()) && a.is("li") && (a = w(a))) { d = a;
                                    a = a.getPrevious(q);
                                ...
                                if (d) { y(c, e, b);
                                    k.cancel() } else if ((e = j.contains(r)) && b.checkBoundaryOfElement(e, CKEDITOR.START)) { d = e.getFirst(q);
                                ...
                                d = 0;
                                if ((a = f.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.getName() in r && a.equals(j)) { d = 1;
                                ...
                                if ((a = f.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.is(r)) {
                                    ...
                                    if (j.block && b.checkStartOfBlock() && b.checkEndOfBlock()) {
                                        ...
                                        b.moveToElementEditStart(a);
                                        b.select()
                                    } else if (w(a)) { b.moveToElementEditStart(a);
    ...
    (function() {
        ...
        function ja(a, c,
            d) { c = c[d ? "getLast" : "getFirst"](function(b) {
        ...
        function P(a, c, d, b) {
            for (var e = function() {
                    ...
                    return n.ie ? function(a) {
                        ...
                        return b.getPropertyValue(a) } }(), f = c.getDocumentPosition(), i = {}, h = {}, g = {}, j = {}, l = t.length; l--;) i[t[l]] = parseInt(e("border-" + t[l] + "-width"), 10) || 0, g[t[l]] =
        ...
        function la(a, c, d, b) {
            for (var e = b, f = b, i = 0, h = !1, g = !1, j = a.view.pane.height, l = a.mouse; l.y + i < j && 0 < l.y - i;) { h || (h = c(e, b));
                g || (g = c(f, b));!h && 0 < l.y - i && (e = d(a, { x: l.x, y: l.y - i }));!g && l.y + i < j && (f = d(a, { x: l.x, y: l.y + i }));
                if (h && g) break;
                i += 2 }
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("pagebreak", {
            ...
            init: function(a) { a.blockless || (a.addCommand("pagebreak", CKEDITOR.plugins.pagebreakCmd), a.ui.addButton && a.ui.addButton("PageBreak", { label: a.lang.pagebreak.toolbar, command: "pagebreak", toolbar: "insert,70" }), CKEDITOR.env.opera && a.on("contentDom", function() { a.document.on("click", function(b) { b = b.data.getTarget();
        ...
        CKEDITOR.plugins.pagebreakCmd = {
            exec: function(a) {
                ...
                a.insertElement(b) },
            context: "div",
            allowedContent: { div: { styles: "!page-break-after" }, span: { match: function(a) {
                        return (a = a.parent) && "div" == a.name && a.styles["page-break-after"] }, styles: "display" } },
    ...
    (function() {
        ...
        var j = "",
            r = function() {
                ...
                var b = this,
                    g = function() {
                        if (!("undefined" != typeof d.instances[b.name] || null != d.instances[b.name])) {
                            ...
                            try { e.setDisabled(!1 === d.isPaused(b)) } catch (n) {}
                ...
                b.on("beforeCommandExec", function(a) { "source" == a.data.name && "source" == b.mode && d.markControlRestore(b) });
                b.on("afterCommandExec", function(a) {
                    if (d.isScaytEnabled(b) && "wysiwyg" ==
                        b.mode && ("undo" == a.data.name || "redo" == a.data.name)) d.getScayt(b).setDisabled(!0), d.refresh_timeout && window.clearTimeout(d.refresh_timeout), d.refresh_timeout = window.setTimeout(function() { d.getScayt(b).setDisabled(!1);
                        d.getScayt(b).focus();
                        d.getScayt(b).refresh() }, 10)
                });
                b.on("destroy", c);
                b.on("setData", c);
        ...
        CKEDITOR.plugins.scayt = {
            ...
            instances: {},
            controlInfo: {},
            setControlInfo: function(a, c) { a && (a.name && "object" != typeof this.controlInfo[a.name]) && (this.controlInfo[a.name] = {});
            ...
            getUiTabs: function(a) {
                var c = [],
                    ...
                    b = b.split(",");
                b[3] = "1";
                for (var d = 0; 4 > d; d++) c[d] = "undefined" != typeof window.scayt && "undefined" != typeof window.scayt.uiTags ? parseInt(b[d], 10) && window.scayt.uiTags[d] : parseInt(b[d], 10); "object" == typeof a.plugins.wsc ? c.push(1) : c.push(0);
                return c },
        ...
        var d = CKEDITOR.plugins.scayt,
            ...
            u = { preserveState: !0, editorFocus: !1, canUndo: !1, exec: function(a) {
                    if (d.isScaytReady(a)) {
                        ...
                        a = d.getScayt(a);
                        a.focus();
                        a.setDisabled(c) } else !a.config.scayt_autoStartup && 0 <= d.engineLoaded && (a.focus(), this.setState(CKEDITOR.TRISTATE_DISABLED), d.loadEngine(a)) } };
        CKEDITOR.plugins.add("scayt", {
            ...
            init: function(a) {
                ...
                1 == c[0] && (b.scaytOptions = { label: h.options, group: "scaytButton", onClick: function() { j = "options";
                ...
                1 == c[2] && (b.scaytDict = { label: h.dictionariesTab, group: "scaytButton", onClick: function() { j = "dictionaries";
                        a.openDialog("scaytcheck") } });
                b.scaytAbout = { label: a.lang.scayt.about, group: "scaytButton", onClick: function() { j = "about";
                        a.openDialog("scaytcheck") } };
                ...
                a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {
                    ...
                    onRender: function() { f.on("state", function() { this.setState(f.state) }, this) },
                    onMenu: function() {
                ...
                a.contextMenu && a.addMenuItems && a.contextMenu.addListener(function(b, c) {
                    ...
                    var j = f.getLang(),
                        ...
                        l = l.split("|"),
                        m;
                    for (m in g) { delete a._.menuItems[m];
                        delete a.commands[m] }
                    for (m in e) {
                        delete a._.menuItems[m];
                        delete a.commands[m]
                    }
                    if (!i || !i.length) { p(a, "no_sugg", h.noSuggestions, "scayt_no_sugg", { exec: function() {} }, "scayt_control", 1, true);
                        ...
                        for (var k = 0, r = i.length; k < r; k = k + 1) {
                            var q = "scayt_suggestion_" + i[k].replace(" ", "_"),
                                t = function(a, b) {
                                    return { exec: function() { f.replace(a, b) } } }(n, i[k]);
                            if (k < s) {
                                p(a, "button_" + q, i[k], q, t, "scayt_suggest",
                                    k + 1);
                                e[q] = CKEDITOR.TRISTATE_OFF
                            } else if (m == "on") { p(a, "button_" + q, i[k], q, t, "scayt_moresuggest", k + 1);
                                g[q] = CKEDITOR.TRISTATE_OFF;
                                j = true }
                        }
                        if (j) { a.addMenuItem("scayt_moresuggest", { label: h.moreSuggestions, group: "scayt_moresuggest", order: 10, getItems: function() {
                                    return g } });
                            e.scayt_moresuggest = CKEDITOR.TRISTATE_OFF }
                    }
                    if (o("all", l) || o("ignore", l)) { p(a, "ignore", h.ignore, "scayt_ignore", { exec: function() { f.ignore(n) } }, "scayt_control", 2);
                        e.scayt_ignore = CKEDITOR.TRISTATE_OFF }
                    if (o("all", l) || o("ignoreall", l)) {
                        p(a, "ignore_all",
                            h.ignoreAll, "scayt_ignore_all", { exec: function() { f.ignoreAll(n) } }, "scayt_control", 3);
                        e.scayt_ignore_all = CKEDITOR.TRISTATE_OFF
                    }
                    if (o("all", l) || o("add", l)) { p(a, "add_word", h.addWord, "scayt_add_word", { exec: function() { window.scayt.addWordToUserDictionary(n) } }, "scayt_control", 4);
            ...
            init: function(c) {
                ...
                c.ui.addRichCombo("Styles", {
                    ...
                    onRender: function() { c.on("selectionChange", function(b) {
                            for (var a = this.getValue(), b = b.data.path.elements, c = 0, d = b.length, g; c < d; c++) { g = b[c];
                                for (var f in e)
                                    if (e[f].checkElementRemovable(g, !0)) { f != a && this.setValue(f);
                                        return } }
                            this.setValue("") }, this) },
                    onOpen: function() {
    ...
    CKEDITOR.plugins.add("table", {
        ...
        init: function(a) {
            function d(a) {
                return CKEDITOR.tools.extend(a || {}, { contextSensitive: 1, refresh: function(a, e) { this.setState(e.contains("table", 1) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED) } }) }
            if (!a.blockless) {
                var b = a.lang.table;
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("undo", {
            init: function(a) {
                ...
                a.on("lockSnapshot",
                    function(a) { b.lock(a.data && a.data.dontUpdate) });
                a.on("unlockSnapshot", b.unlock, b)
            }
        });
        CKEDITOR.plugins.undo = {};
        var f = CKEDITOR.plugins.undo.Image = function(a, c) { this.editor = a;
        ...
        g.prototype = {
            ...
            save: function(a, c, d) {
                ...
                if (this.currentImage)
                    if (c.equalsContent(this.currentImage)) {
                        if (a || c.equalsSelection(this.currentImage)) return !1 } else this.editor.fire("change");
                b.splice(this.index +
                ...
                if (d)
                    if (a)
                        for (b = this.index - 1; 0 <= b; b--) {
                            if (a = c[b], !d.equalsContent(a)) return a.index = b, a } else
            ...
            redo: function() {
                ...
                return !1 },
            update: function(a) {
                if (!this.locked) { a || (a = new f(this.editor));
